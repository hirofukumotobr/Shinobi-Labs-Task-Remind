...
export const translations: Record<'pt' | 'en', Translations> = {
  pt: {
    ...
    taskFormClientLabel: 'Clientes (pode escolher mais de um)',
    taskFormManageClients: 'Gerenciar clientes',
    taskFormNoClient: 'Nenhum cliente cadastrado.',
  ...
  en: {
    ...
    taskFormClientLabel: 'Clients (choose as many as you like)',
    taskFormManageClients: 'Manage clients',
    taskFormNoClient: 'No clients yet.',
